    ...
    <div class="card-group">
      ...
      <div class="card bg-light">
        <div class="card-body">
          ...
          <p class="card-text letra3 palabra1">Tenemos el mejor Equipo de Trabajo que te ayudara paso a paso para que puedas inscribirte en cualquier programa de Beneficiarios que este más cerca a tu casa.<br><br><a href="?c=Landing&a=proyecto">Conoce más Aquí.</a></p>
        </div>
      </div>
    </div>
